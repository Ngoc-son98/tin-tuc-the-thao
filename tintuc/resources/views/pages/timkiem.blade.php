                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-nav-area">
                            ...
                            <p class="text-white link-nav"><a href="">Trang chủ </a>  <span class="lnr lnr-arrow-right"></span><a href="">tìm kiếm</a></p>
                        </div>
                    </div>
                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-8 post-list">
                        ...
                        <div class="latest-post-wrap">
                            <h4 class="cat-title">Kết quả tìm kiếm</h4>
                            @foreach($listnew as $post)
                                <div class="single-latest-post row align-items-center">
                                    <div class="col-lg-5 post-left">
                                        <div class="feature-img relative">
                                            <div class="overlay overlay-bg"></div>
                                            <img class="img-fluid p2" src="{{asset('asset/tintuc/'.$post->Hinh)}}" alt="">
                                            <style>
                                                img.p2{
                                                    height: 200px;
                                                }
                            ...
                            <div class="single-sidebar-widget editors-pick-widget">
                                ...
                                <div class="editors-pick-post">
                                    <div class="feature-img-wrap relative">
                                        <div class="feature-img relative">
                                            <div class="overlay overlay-bg"></div>
                                            <img class="img-fluid" src="{{asset('asset/tintuc/'.$highlightpost[0]->Hinh)}}" alt="">
                                        </div>
                                        <ul class="tags">
                                    ...
                                    <div class="post-lists">
                                        ...
                                        @foreach($highlightpost as $post)
                                            <div class="single-post d-flex flex-row">
                                                <div class="thumb">
                                                    <img class="img-fluid p3" src="{{asset('asset/tintuc/'.$post->Hinh)}}" alt="">
                                                    <style>
                                                        img.p3 {
                                                            height: 100px;
                                                            width: 100px;
